...
from network.frontend import Leaf
...
class ConvBlock(tf.keras.Sequential):
  ...
  def __init__(self,
               ...
               dropout: float = CONF.ConvBlock_dropout,
...
class ConvNet(tf.keras.Sequential):
  ...
  def __init__(self, filters: Sequence[int] = CONF.ConvNet_Filters, **kwargs):
