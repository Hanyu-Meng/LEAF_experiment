...
class ExponentialMovingAverage(tf.keras.layers.Layer):
  ...
  def __init__(
      ...
      per_channel: bool = CONF.sPCEN_pre_channel, trainable: bool = CONF.sPCEN):
...
class PCENLayer(tf.keras.layers.Layer):
  ...
  def __init__(self,
               ...
               root: float = 2.0,
               floor: float = 1e-6,
               trainable: bool = CONF.PCEN,
               learn_smooth_coef: bool = CONF.sPCEN,
               per_channel_smooth_coef: bool = CONF.sPCEN_pre_channel,
               name='PCEN'):
    """PCEN constructor.
